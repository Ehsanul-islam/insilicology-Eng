  ...
  IF NEW.status = 'pending' AND (OLD IS NULL OR OLD.status != 'pending') THEN
    ...
    SELECT net.http_post(
      ...
      body := json_build_object(
        'sender', json_build_object('name', 'Zymios', 'email', 'noreply@zymios.com'),
