...
export const EnrollmentDialog = ({ course, open, onOpenChange, onSuccess }: EnrollmentDialogProps) => {
  ...
  const [step, setStep] = useState<'form' | 'payment' | 'upload' | 'review'>('form');
  ...
  const renderPaymentStep = () => (
    <div className="space-y-4">
      ...
      <div className="flex justify-between pt-4">
        ...
        <Button onClick={() => setStep('upload')} disabled={!paymentMethod}>
          Continue
        </Button>
      </div>
    </div>
  ...
  const renderUploadStep = () => (
    <div className="space-y-4">
      ...
      <div className="flex justify-between pt-4">
        ...
        <Button onClick={() => setStep('review')} disabled={!paymentProof}>
          Review Submission
        </Button>
      </div>
    </div>
  ...
  const renderReviewStep = () => (
    <div className="space-y-4">
      ...
      <div className="flex justify-between pt-4">
        <Button variant="outline" onClick={() => setStep('upload')} disabled={loading || uploading}>
          Back
        </Button>
