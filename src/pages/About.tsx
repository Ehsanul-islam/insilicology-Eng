...
const About = () => {
    ...
    return (
        <div className="min-h-screen font-siliguri text-[16px]">
            <SEOHead
                title="About Us - Empowering Futures Through Education | LearnCraft"
                description="Learn about our mission to transform lives through education. Meet the team behind LearnCraft and discover our story."
                url="/about"
                type="website"
            />
            <Navbar />
                        ...
                        <div className="grid md:grid-cols-2 gap-12 items-center">
                            ...
                            >
                                ...
                                <div className="space-y-4 text-muted-foreground text-lg">
                                    <p>
                                        Founded in 2020, LearnCraft began with a simple idea: that quality education should be accessible to everyone. What started as a small collection of coding tutorials has grown into a comprehensive learning platform serving thousands of students worldwide.
                                    </p>
                                    <p>
