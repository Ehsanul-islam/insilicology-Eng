...
const CookiePolicy = () => {
  ...
  return (
    <div className="min-h-screen font-siliguri text-[16px]">
      <SEOHead
        title="Cookie Policy - How We Use Cookies | insilicology"
        description="Understand how insilicology uses cookies to improve your learning experience. Read our detailed Cookie Policy."
        url="/cookies"
        type="website"
              ...
              <Card>
                <CardContent className="p-8">
                  <p className="text-lg text-foreground/80 leading-relaxed">
                    This Cookie Policy explains how insilicology ("we", "us", and "our") uses cookies and similar technologies to recognize you when you visit our website. It explains what these technologies are and why we use them, as well as your rights to control our use of them.
                  </p>
                </CardContent>
              </Card>
            </motion.div>
