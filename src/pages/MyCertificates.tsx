...
const MyCertificates = () => {
  ...
  const handleShare = async (certificate: Certificate) => {
    ...
    const shareText = `I earned a certificate for completing "${certificate.courseName}" at insilicology! Verify it here:`;

    if (navigator.share) {
      try {
        await navigator.share({
          title: `insilicology Certificate - ${certificate.courseName}`,
          text: shareText,
          url: verificationUrl,
        });
      } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-gradient-subtle">
      <SEOHead
        title="My Certificates - insilicology"
