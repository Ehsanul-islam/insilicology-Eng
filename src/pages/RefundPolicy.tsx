...
const RefundPolicy = () => {
    const sections = [
      ...
      `,
        ...
        <ol>
          ...
          <li>Alternatively, you can email our support team at support@learncraft.com with your order details and reason for the refund.</li>
        </ol>
      `,
        },
        {
    ...
    return (
        <div className="min-h-screen font-siliguri text-[16px]">
            <SEOHead
                title="Refund Policy - 30-Day Money-Back Guarantee | LearnCraft"
                            ...
                            <Card>
                                <CardContent className="p-8">
                                    <p className="text-lg text-foreground/80 leading-relaxed">
                                        At LearnCraft, we are committed to providing high-quality educational content. However, we understand that sometimes a course might not be the right fit. This Request Policy outlines the terms and conditions for refunds on our platform.
                                    </p>
                                </CardContent>
                            </Card>
                        </motion.div>
