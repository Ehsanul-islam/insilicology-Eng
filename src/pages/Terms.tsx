...
const Terms = () => {
  const sections = [
    {
      ...
      content: `
        <p>By accessing and using LearnCraft ("Service"), you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to these Terms of Service, please do not use our Service.</p>
    ...
    },
    {
      ...
      content: `
        <p>The Service and its original content (excluding user content), features, and functionality are and will remain the exclusive property of LearnCraft and its licensors.</p>
        <p>Our trademarks and trade dress may not be used in connection with any product or service without our prior written consent. You may not use our intellectual property in any way that is likely to cause confusion or disparages LearnCraft.</p>
      `,
    },
    {
      ...
      content: `
        ...
        <ul>
          ...
          <li>Remain the property of LearnCraft</li>
    ...
    },
    {
      ...
      content: `
        <p>To the maximum extent permitted by law, LearnCraft shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to loss of profits, data, or other intangible losses resulting from:</p>
        <ul>
    ...
    },
    {
      ...
      content: `
        <p>These Terms shall be governed by and construed in accordance with the laws of the jurisdiction in which LearnCraft operates, without regard to its conflict of law provisions.</p>
    ...
    },
    {
      ...
      content: `
        ...
        <ul>
          <li>Email: legal@learncraft.com</li>
  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        title="Terms of Service - User Agreement | LearnCraft"
        description="Read LearnCraft's terms of service to understand your rights and responsibilities when using our learning platform."
        url="/terms"
        type="website"
              ...
              <Card>
                <CardContent className="p-8">
                  <p className="text-lg text-foreground/80 leading-relaxed">
                    Welcome to LearnCraft. These Terms of Service ("Terms") govern your use of our website, mobile applications, and services (collectively, the "Service"). Please read these Terms carefully before using our Service. By accessing or using the Service, you agree to be bound by these Terms and our Privacy Policy.
                  </p>
                </CardContent>
              </Card>
            </motion.div>
